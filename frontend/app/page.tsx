...
export default function Home() {
  const [companyName, setRepoUrl] = useState("");
  ...
  useEffect(() => {
    ...
    async function restoreWorkspace() {
      try {
        ...
        setRepoUrl(stored.companyName); setRunId(stored.runId); setSelectedPhases(storedSelected); setMode(stored.mode ?? "parallel"); setObjective(stored.objective ?? "document");
